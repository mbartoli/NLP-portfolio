...
public class DiscountLMModel implements LMModel {
	...
	// the total number of words, we start the number of words off at 3
	int wordCount = 0;
...
//        
//        Set<String> keys = bigramProbability.keySet();
//        for(String key: keys){
//        	Set<String> innerKeys = bigramProbability.get(key).keySet();
//        	for (String innerKey : innerKeys) {
//        		System.out.println("Value of ("+key+ " " + innerKey +"): "+bigramProbability.get(key).get(innerKey));
//        	}
//        }
//        
//        System.out.println("The alpha values are:");
//        Set<String> alphaKeys = alphaValues.keySet();
//        for (String key: alphaKeys) {
//        	System.out.println("alpha of " + key + " is " + alphaValues.get(key));
//        }
	...
	public double getBigramProb(String first, String second) {
		...
		if (bigramProbability.containsKey(first)) {
			...
			return alphaValues.get(first) * (unigramFrequency.get(second)/wordCount);
		}
	}
	
	public static void main(String[] args) {
		DiscountLMModel lm = new DiscountLMModel("training.txt", .99);
		System.out.println(".99: "+ lm.getPerplexity("testing.txt"));
		lm = null;
		DiscountLMModel lm2 = new DiscountLMModel("training.txt", .9);
		System.out.println(".9: " + lm2.getPerplexity("testing.txt"));
		lm2=null;
		DiscountLMModel lm3 = new DiscountLMModel("training.txt", .75);
		System.out.println(".75: " + lm3.getPerplexity("testing.txt"));
		lm3=null;
		DiscountLMModel lm4 = new DiscountLMModel("training.txt", .5);
		System.out.println(".5: " + lm4.getPerplexity("testing.txt"));
		lm4=null;
		
		DiscountLMModel lm5 = new DiscountLMModel("training.txt", .25);
		System.out.println(".25: " + lm5.getPerplexity("testing.txt"));
		lm5=null;
		DiscountLMModel lm6 = new DiscountLMModel("training.txt", .1);
		System.out.println(".1: " + lm6.getPerplexity("testing.txt"));
	}
